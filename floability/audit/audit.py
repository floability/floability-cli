...
from floability.audit.generate_verified_env_yaml import main as generate_verified_env_yaml
...
def audit(notebook_path, kernel_name):
    ...
    generate_verified_env_yaml('worker_requirements.txt', output='worker_environment.yml')

    generate_verified_env_yaml('manager_requirements.txt', output='manager_environment.yml')
