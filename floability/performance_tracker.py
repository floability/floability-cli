...
class PerformanceTracker:
    ...
    def measure_file_size(self, path, name=None):
        ...
        self.record_metric("file_sizes", metric_name, size_mb, unit="MB", 
                         description=f"Size of {path}")
    ...
    def save_report(self):
        ...
        # Save to file
        report_file = os.path.join(self.output_dir, f"performance_report_{int(time.time())}.json")
